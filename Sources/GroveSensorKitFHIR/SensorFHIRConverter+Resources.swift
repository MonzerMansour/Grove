...
extension SensorFHIRConverter {
    ...
    static func attachment(_ record: GroveSensorRecordingDocument) throws -> Attachment {
        let bytes: Data
    ...
    static func applicationDevice(_ application: SensorFHIRApplication) -> Device {
        var device = Device()
    ...
    static func recordingDevice(_ source: SensorFHIRRecordingDevice) -> Device {
        var device = Device()
